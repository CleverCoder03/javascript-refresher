...
/*
    3. Use a `for-of' loop to iterate through the array [1, 2, 3, 4, 5]' and stop when the number '4' is found. Store the numbers before '4' in an array named small Numbers'.
*/
...
/*
    7. Write a `forEach `["earl grey", "green tea", "chai", "oolong tea"]'. Stop the loop when `"chai"' is found, and store all previous tea types in an array named `availableTeas'.
*/
